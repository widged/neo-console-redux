...
/***/ function(module, exports, __webpack_require__) {
	...
	var _mainEs6Js = __webpack_require__(1);

	var _mainEs6Js2 = _interopRequireDefault(_mainEs6Js);

	(0, _mainEs6Js2['default'])();
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _libsCypherQuerierCypherQuerierEs6Js = __webpack_require__(159);

	var _libsCypherQuerierCypherQuerierEs6Js2 = _interopRequireDefault(_libsCypherQuerierCypherQuerierEs6Js);

	var _componentsCypherConsoleReactCypherConsoleEs6Js = __webpack_require__(160);

	var _componentsCypherConsoleReactCypherConsoleEs6Js2 = _interopRequireDefault(_componentsCypherConsoleReactCypherConsoleEs6Js);

	var _libsAsyncPipeAsyncPipeEs6Js = __webpack_require__(161);

	var _libsAsyncPipeAsyncPipeEs6Js2 = _interopRequireDefault(_libsAsyncPipeAsyncPipeEs6Js);

	var Component = _react2['default'].Component;

	function main() {

		var cypherQuerier = new _libsCypherQuerierCypherQuerierEs6Js2['default']();
		var consoleUrl = _libsCypherQuerierCypherQuerierEs6Js2['default'].getConsoleUrl('http://neo4j-console-22.herokuapp.com/', 'none', 'none', '\n\nUse the play/edit buttons to run the queries!');

		var rConsole = _reactDom2['default'].render(_react2['default'].createElement(
			'wg-app',
			null,
			_react2['default'].createElement(_componentsCypherConsoleReactCypherConsoleEs6Js2['default'], { onLoaded: onCypherReady, consoleUrl: consoleUrl }),
			_react2['default'].createElement(
				...
				_react2['default'].createElement(
					'code',
					null,
					_react2['default'].createElement('div', { id: 'console-ouput' })
				)
			)
		...
		function runQueries() {
			new _libsAsyncPipeAsyncPipeEs6Js2['default'](function (next, acc) {
				var output = document.getElementById('console-ouput');
				...
				return [function () {
					...
					cypherQuerier.post(query, false).then(function (err, d) {
						write('-- MATCHED --');
						write(d ? JSON.stringify(d.json, null, 2) : d);
						next();
					});
				}];
			}).then(function (acc) {
...
/***/ function(module, exports) {
	...
	var CypherQuerier = (function () {
		function CypherQuerier() {
			_classCallCheck(this, CypherQuerier);

			this.state = { consoleFrame: undefined };
		}

		_createClass(CypherQuerier, [{
			key: 'consoleFrame',
			value: function consoleFrame(_) {
				if (!arguments.length) {
					return this.state.consoleFrame;
				}
			...
			key: 'post',
			value: function post(data, isConsoleUpdated) {
				var consoleFrame = this.state.consoleFrame;

				if (!Array.isArray(data)) {
					data = [data];
				}

				var then = function then(thenFn) {
			...
			key: 'getConsoleUrl',
			value: function getConsoleUrl(consoleUrl, database, command, message, session, neo4jVersion) {
				/*
	   ...
	   */
		...
		return CypherQuerier;
	})();

	exports['default'] = CypherQuerier;
	module.exports = exports['default'];
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CypherConsole = (function (_Component) {
		_inherits(CypherConsole, _Component);

		function CypherConsole() {
			_classCallCheck(this, CypherConsole);

			_get(Object.getPrototypeOf(CypherConsole.prototype), 'constructor', this).apply(this, arguments);
		}

		_createClass(CypherConsole, [{
			...
			value: function render() {
				var consoleUrl = this.props.consoleUrl;
				...
				return _react2['default'].createElement(
					...
					_react2['default'].createElement(
						'iframe',
						{ ref: 'iframe', className: 'cypherdoc-console', src: consoleUrl, width: '600', height: '400' },
...
/***/ function(module, exports) {
	...
	var AsyncPipe = (function () {
	    ...
	    _createClass(AsyncPipe, [{
	        key: 'then',
	        value: function then(lastFn) {
	            var listFn = this.state.listFn;
