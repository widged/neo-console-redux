...
/***/ function(module, exports, __webpack_require__) {
	...
	function main() {
		...
		var rConsole = _reactDom2['default'].render(_react2['default'].createElement(_componentsCypherConsoleReactCypherConsoleEs6Js2['default'], { onLoaded: onCypherReady, consoleUrl: consoleUrl }), document.getElementById('app'));
		...
		function runQueries() {
			new _libsAsyncPipeAsyncPipeEs6Js2['default'](function (next, acc) {
				return [function () {
					...
					cypherQuerier.post(query, false).then(function (err, d) {
						console.log('-- MATCHED --');
						console.log(d ? JSON.stringify(d.json) : d);
						next();
					});
				}];
			}).then(function (acc) {
